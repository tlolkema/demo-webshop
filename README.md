...
A simple cat-breed demo application built with HTML, CSS, and JavaScript. This project serves as a demonstration application for AI agent workshops and testing purposes.

<div align="center">
  <img src="./img/fruit-shop-logo.png" alt="Cat Shop" width="400" height="auto" />
</div>

## Features

- 🐱 **Breed Catalog**: Browse cat breeds (Siamese, Persian, Maine Coon, Ragdoll, Bengal, Sphynx, British Shorthair, Scottish Fold, Devon Rex, Abyssinian)
